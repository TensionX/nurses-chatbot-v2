  ...
  async function getCurrentSchool(){
    ...
    async function get_current_school(){
      ...
      return {
        date: today(),
        school: {
          name: current_schedule.scheduledWork.school_name,
          address: current_schedule.scheduledWork.school_address,
          eWebRecordID: current_schedule.scheduledWork.eWebRecordID,
          call_in_time: current_schedule.call_in_time
        }
      };
    }
