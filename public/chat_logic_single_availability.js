...
function start_over(){
    // Clear all localStorage items set with storageSet
    storageSet("provided_availability", null);
    storageSet("date", null);
    storageSet("selected_borough", null);
    storageSet("current_school", null);
    storageSet("call_in_time", null);

    // Add any other items you've set with storageSet
    // For example:
    // storageSet("item_name", null);
